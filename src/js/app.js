...
function startApp() {
  $.getJSON('file:///Users/zhangyuanyi/Downloads/KYCNFTDev/KYC%20Provider/KYCNFT/contracts/artifacts/KYCNFT.json', function(data) {
    var KYCNFTABI = data;    
    cryptoZombies = TruffleContract(KYCNFTABI);
